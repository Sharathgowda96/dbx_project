...
from cicd_sample.tasks.sample_etl_task import SampleETLTask
from cicd_sample.tasks.sample_ml_task import SampleMLTask
...
def test_jobs(spark: SparkSession, tmp_path: Path):
    ...
    test_ml_config = {
        "input": common_config,
        "experiment": "/Shared/cicd-sample/sample_experiment"
    }
